...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException ex) {
        ...
        String codeName = (errorCode == ErrorCode.VALIDATION_ERROR) ? ErrorCode.ERR_INVALID_REQUEST.name() : errorCode.name();
        ApiResponse<Void> response = ApiResponse.error(codeName, ex.getMessage());
    ...
    public ResponseEntity<ApiResponse<Void>> handleValidationException(MethodArgumentNotValidException ex) {
        ...
        ApiResponse<Void> response = ApiResponse.error(errorCode.name(), errorCode.getDefaultMessage(), errors);
        return new ResponseEntity<>(response, errorCode.getHttpStatus());
    }
