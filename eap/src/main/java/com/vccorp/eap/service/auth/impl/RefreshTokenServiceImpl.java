package com.vccorp.eap.service.auth.impl;
...
/**
 * Lớp thực thi của RefreshTokenService.
 * Hiện thực hóa logic xoay vòng Refresh Token (Token Rotation) nhằm tăng cường bảo mật và phòng chống replay attacks.
 */
@Service
public class RefreshTokenServiceImpl implements RefreshTokenService {
    ...
    /**
     * Khởi tạo RefreshTokenServiceImpl với các dependency tương ứng.
     */
    public RefreshTokenServiceImpl(RedisService redisService,
    ...
    /**
     * Sinh key lưu trữ Refresh Token của người dùng trong Redis.
     */
